...
/** Public asset URLs for skills and graphics. */
function skillAsset(file: string) {
  return `/originkit/hero-06/skills/${file}`;
}

const TWO_PI = Math.PI * 2;

// 21 skill badges: Programming Languages, Soft Skills, and Sports / Mastery.
const DEFAULT_IMAGES = [
  { src: skillAsset("typescript.svg") },
  { src: skillAsset("python.svg") },
  { src: skillAsset("react.svg") },
  { src: skillAsset("rust.svg") },
  { src: skillAsset("leadership.svg") },
  { src: skillAsset("pytorch.svg") },
  { src: skillAsset("golang.svg") },
  { src: skillAsset("communication.svg") },
  { src: skillAsset("docker.svg") },
  { src: skillAsset("problem-solving.svg") },
  { src: skillAsset("sql.svg") },
  { src: skillAsset("chess-strategy.svg") },
  { src: skillAsset("cpp.svg") },
  { src: skillAsset("collaboration.svg") },
  { src: skillAsset("archery-focus.svg") },
  { src: skillAsset("javascript.svg") },
  { src: skillAsset("negotiation.svg") },
  { src: skillAsset("endurance.svg") },
  { src: skillAsset("design-thinking.svg") },
  { src: skillAsset("martial-arts.svg") },
  { src: skillAsset("motorsport.svg") },
];

/** Originkit control defaults — tuned for skill badge vortex */

        ...
        headers: [
          ...
          { key: 'Strict-Transport-Security', value: 'max-age=31536000; includeSubDomains' },
          {
            ...
            value: [
              ...
              "connect-src 'self' https://*.googleapis.com https://*.firebaseio.com https://securetoken.googleapis.com https://identitytoolkit.googleapis.com https://*.upstash.io ws: wss:",
